...
console.log("🔹 Step 0: get intro show flag");introFlags=await loadStep([checkIntroFlags(),loadCSS("https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css"),loadScript("https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js")],signal);console.log("🔹 Step 1: processing returned or skipped");if(introFlags.includes("returned")){await loadStep([prepareSkipButtons(".slide-container.zero-slide ~ [class*='-slide']",controller),],signal);}
